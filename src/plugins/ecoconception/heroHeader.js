export function heroHeader (editor, options = {}) {
    editor.Blocks.add('heroHeader', {
        label : 'Hero Header',
        content : `<div class="header-type-1 customizable-header customizable-content texte-centre customizable-wrapper" style="display: block;">
        <div class="background-container">
        <img style="width: 100%; height: 90%; position: absolute; z-index: -1"></img>
            <div class="background-content">
                <h1>Ensemble <br> protégeons <br> <span class="white-outline">les océans</span></h1>
                <hr>
                <p>Notre objectif : s'engager pour préserver l'eau, <br> nos écosystèmes et le vivant, en agissant à la source !</p>
            </div>
        </div>
    </div>
