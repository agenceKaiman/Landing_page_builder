export function headerDeroulant (editor, options = {}) {
    const {
      ...
      editor.Blocks.add('headerDeroulant', {
          label : 'Header deroulant',
          content : `<nav class="menu-type-2 customize-option-bloc customizable-menu customizable-wrapper clearfix" style="display: block;">
          <div class="menu-logo gauche">
              <image viewBox="0 0 200 200" class="gauche">
              </image>
              <p class="logo-text gauche" style="color: rgb(6, 6, 142);">
                  Protégeons
                  <br>
                  <span class="outline" style="-webkit-text-stroke: 1px rgb(6, 6, 142);">Acceuil</span>
              </p>
          </div>
          <div class="droite">
              <a href="#" class="donation-button" style="background-color: rgb(6, 6, 142); color: rgb(255, 255, 255);">Faire un don</a>
          </div>
          ...
          <ul class="one-line-menu droite">
              <li class="first-level-menu">Nos actions
                  <ul class="submenu" style="background-color: rgb(255, 255, 255);">
                      <li>Protection</li>
                      <li>Formation</li>
              ...
              <li class="first-level-menu">L'association
                  <ul class="submenu" style="background-color: rgb(255, 255, 255);">
                      <li>Engagement</li>
                      <li>Équipe</li>
                  </ul>
              ...
              <li class="first-level-menu">Actualité
                  <ul class="submenu" style="background-color: rgb(255, 255, 255);">
                      <li>Enquêtes</li>
                      <li>Recherches</li>
                  </ul>
              ...
              <li class="first-level-menu">Contact
                  <ul class="submenu" style="background-color: rgb(255, 255, 255);">
                      <li>Formulaire</li>
                      <li>Nous trouver</li>
                  </ul>
          ...
          <div class="menu-type-2-responsive menu-responsive-wrapper" style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);">
